  ...
  const columns = useMemo(() => {
    ...
    if (role === 'ADMIN') {
      baseColumns.push({
        ...
        render: (_, member) => (
          <Button
            className={member.active ? 'fm-deactivate-button' : 'fm-activate-button'}
    ...
    <div>
      <div
        ...
        <div style={{ display: 'flex', alignItems: 'center', gap: 12, flexWrap: 'wrap', marginBottom: 16 }}>
          ...
          <Button className="fm-refresh-button" icon={<ReloadOutlined />} onClick={loadMembers} loading={loading}>
            Refresh
          </Button>
